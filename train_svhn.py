...
flags = tf.app.flags
flags.DEFINE_integer('gpu', 0, 'labeled data per class')
flags.DEFINE_integer('batch_size', 100, "batch size [50]")
flags.DEFINE_string('data_dir', '/tmp/data/svhn/','')
...
flags.DEFINE_boolean('validation', False, 'enable manifold reg')
flags.DEFINE_integer('decay_start', 399, 'start of learning rate decay')
